...
calc_error = 'Произошла ошибка при расчете оценки. Пожалуйста проверьте еще раз оценки которые вы вводите. В случае если '\
    'вы считаете, что вводите все верно, сообщите об этом случае админу.'
